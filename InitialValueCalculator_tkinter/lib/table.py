...
class Table(tk.Frame):
    ...
    def layout(self):
        ...
        headerU = tk.Label(self, text=str(self.header[0]), border=2, relief="raised", bg="#343434", fg="#d1d1d1")
        headerV = tk.Label(self, text=str(self.header[1]), border=2, relief="raised", bg="#343434", fg="#d1d1d1")
        titleRow.grid(row=0, column=0, columnspan=2, sticky="EW")
        headerU.grid(row=1, column=0, sticky="EW")
        headerV.grid(row=1, column=1, sticky="EW")
        if isinstance(self.rows[0], list):
            ...
            for i, r in enumerate(self.rows):
                ...
                cell.grid(row=i+2, column=0, sticky="EW")
